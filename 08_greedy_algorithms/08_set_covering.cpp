...
std::unordered_set<std::string> operator & (const std::unordered_set<std::string>& a, const std::unordered_set<std::string>& b) 
{
...
void operator -= (std::unordered_set<std::string>& a, const std::unordered_set<std::string>& b) 
{
